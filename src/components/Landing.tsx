...
const Landing = () => {
   return (
      <div className='flex h-screen flex-col items-center justify-between bg-gray-200 px-10 sm:flex-row'>
         <div className='container mb-10 mt-10 text-center sm:mb-0 sm:text-left'>
